      ...
      <div className="column">
            ...
            <div className="preview-content">
              ...
              {this.props.isExpanded ? <div className="preview-expanded">
                ...
                {preview.organisation.length > 0 ? <div className="preview-organization"><strong>Agentur:</strong> { this.getDetailFilter(preview.organisation, 'publisher',this.props.isExpanded) }</div> : ''}
              </div> : ''}
